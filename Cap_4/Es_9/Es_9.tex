...
Le seguenti figure mostrano l'andamento della \textit{Spline cubica Naturale} e della \textit{Spline cubica NotAKnot}, al variare del grado \textit{N} del polinomio con $N=2,4,6,8...40$ :\\\
	\begin{figure}
		\subfloat[][$n=4$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_4)}} \quad
		\subfloat[][$n=6$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_6)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=8$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_8)}} \quad
		\subfloat[][$n=10$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_10)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=12$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_12)}} \quad
		\subfloat[][$n=14$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_14)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=16$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_16)}} \quad
		\subfloat[][$n=18$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_18)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=20$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_20)}} \quad
		\subfloat[][$n=22$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_22)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=24$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_24)}} \quad
		\subfloat[][$n=26$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_26)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=28$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_28)}} \quad
		\subfloat[][$n=30$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_30)}}
	\end{figure}
	\begin{figure} 
		\subfloat[][$n=32$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_32)}} \quad
		\subfloat[][$n=34$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_34)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=36$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_36)}} \quad
		\subfloat[][$n=38$]
			{\includegraphics[width=.55\textwidth]{Plot/Cap_4_Es_9_(n_38)}}
	\end{figure}
	\begin{figure}
		\subfloat[][$n=40$]
